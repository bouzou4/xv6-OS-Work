...
void tail(int fd)
{
  ...
  3c:	7f ca                	jg     8 <tail+0x8>
    if(n < 0){
  3e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  42:	79 17                	jns    5b <tail+0x5b>
...
printf(int fd, char *fmt, ...)
{
 ...
 5b5:	75 25                	jne    5dc <printf+0xff>
          s = "(null)";
 5b7:	c7 45 f4 bb 08 00 00 	movl   $0x8bb,-0xc(%ebp)
        while(*s != 0){
