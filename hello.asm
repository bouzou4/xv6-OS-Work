...
printint(int fd, int xx, int base, int sgn)
{
 ...
 392:	0f b6 80 0c 0a 00 00 	movzbl 0xa0c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 4ce:	75 25                	jne    4f5 <printf+0xff>
          s = "(null)";
 4d0:	c7 45 f4 bc 07 00 00 	movl   $0x7bc,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 596:	a1 28 0a 00 00       	mov    0xa28,%eax
 ...
 661:	a3 28 0a 00 00       	mov    %eax,0xa28
}
 666:	90                   	nop
 667:	c9                   	leave  
 668:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 6bf:	83 c4 10             	add    $0x10,%esp
  return freep;
 6c2:	a1 28 0a 00 00       	mov    0xa28,%eax
}
 6c7:	c9                   	leave  
 6c8:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 6db:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 6de:	a1 28 0a 00 00       	mov    0xa28,%eax
 6e3:	89 45 f0             	mov    %eax,-0x10(%ebp)
 6e6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 6ea:	75 23                	jne    70f <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 6ec:	c7 45 f0 20 0a 00 00 	movl   $0xa20,-0x10(%ebp)
 6f3:	8b 45 f0             	mov    -0x10(%ebp),%eax
 6f6:	a3 28 0a 00 00       	mov    %eax,0xa28
 6fb:	a1 28 0a 00 00       	mov    0xa28,%eax
 700:	a3 20 0a 00 00       	mov    %eax,0xa20
    base.s.size = 0;
 705:	c7 05 24 0a 00 00 00 	movl   $0x0,0xa24
 70c:	00 00 00 
  }
 ...
 762:	a3 28 0a 00 00       	mov    %eax,0xa28
      return (void*)(p + 1);
 ...
 76d:	eb 3b                	jmp    7aa <malloc+0xe1>
    ...
    if(p == freep)
 76f:	a1 28 0a 00 00       	mov    0xa28,%eax
